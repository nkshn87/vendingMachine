...
var VendingMachine_1 = require("../classes/VendingMachine");
...
describe('vendingMachine', function () {
    describe('constructor', function () {
        it('インスタンス化されている', function () {
            ...
            expect(vendingMachine).toBeInstanceOf(VendingMachine_1.VendingMachine);
        });
    });
    ...
    describe('getBuyableItems', function () {
        it('商品一覧を取得', function () {
            var expectedItemList = [
                new Item_1.Item('item1', oneHundredYen),
                new Item_1.Item('item2', oneHundredYen),
                new Item_1.Item('item3', oneHundredYen),
            ];
            var vendingMachine = new VendingMachine_1.VendingMachine();
            vendingMachine['deposit'].addDeposit(oneHundredYen); // 残金追加
        ...
        it('残金以上の商品は表示しない', function () {
            var expectedItemList = [new Item_1.Item('item1', oneHundredYen)];
            var vendingMachine = new VendingMachine_1.VendingMachine();
            vendingMachine['deposit'].addDeposit(oneHundredYen); // 残金追加
            vendingMachine['stockManage'].addStock('item1', oneHundredYen, oneStock);
        ...
        it('残金が0円の場合は、商品の値段に関わらず、在庫のある全ての商品を取得', function () {
            var expectedItemList = [new Item_1.Item('item1', oneHundredYen), new Item_1.Item('item2', twoHundredYen)];
            var vendingMachine = new VendingMachine_1.VendingMachine();
    ...
    describe('createMenuOutputText', function () {
        it('テキストリストを装飾・整形し返却', function () {
            var itemList = [new Item_1.Item('item1', oneHundredYen), new Item_1.Item('item2', oneHundredYen)];
            var expectedItemList = [
                new Item_1.Item('item1', oneHundredYen),
                new Item_1.Item('item2', oneHundredYen),
                new Item_1.Item('item3', oneHundredYen),
